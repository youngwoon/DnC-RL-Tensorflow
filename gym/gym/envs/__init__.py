...
register(
    id='JacoPickSmallerBox-v1',
    entry_point='gym.envs.mujoco:JacoPickSmallerBoxEnv',
...
register(
    id='JacoShoot-v1',
    entry_point='gym.envs.mujoco:JacoShootEnv',
...
register(
    id='JacoPlace-v1',
    entry_point='gym.envs.mujoco:JacoPlaceEnv',
    max_episode_steps=100,
)

register(
    id='JacoPlaceOnly-v1',
    entry_point='gym.envs.mujoco:JacoPlaceOnlyEnv',
    max_episode_steps=100,
)
...
register(
    id='MetaJaco-v1',
    entry_point='gym.envs.mujoco:MetaJaco_v1_Env',
    max_episode_steps=1000,
)

register(
    id='MetaJaco-v2',
    entry_point='gym.envs.mujoco:MetaJaco_v2_Env',
    max_episode_steps=1000,
)

register(
    id='MetaJacoCatchOrPickAndShoot-v1',
    entry_point='gym.envs.mujoco:MetaJaco_v2_Env',
    max_episode_steps=1000,
)

register(
    id='MetaJacoCatchOrPickAndShootWoRot-v2',
    entry_point='gym.envs.mujoco:MetaJaco_v2_Env',
    max_episode_steps=1000,
    kwargs={'with_rot': 0},
)
...
register(
    id='Walker2dLower-v1',
    max_episode_steps=1000,
    entry_point='gym.envs.mujoco:Walker2dLowerEnv',
)

register(
    id='Walker2dStandup-v1',
    max_episode_steps=1000,
    entry_point='gym.envs.mujoco:Walker2dStandupEnv',
)
...
register(
    ...
    entry_point='gym.envs.mujoco:MetaWalker2d_v1_Env',
)

register(
    id='MetaWalker2d-v2',
    max_episode_steps=1500,
    entry_point='gym.envs.mujoco:MetaWalker2d_v2_Env',
)

register(
    id='MetaWalker2d-v3',
    max_episode_steps=1500,
    entry_point='gym.envs.mujoco:MetaWalker2d_v3_Env',
)
...
register(
    id='HumanoidSwimForward-v1',
    entry_point='gym.envs.mujoco:HumanoidSwimForwardEnv',
    max_episode_steps=1000
)

register(
    id='HumanoidSwimBackward-v1',
    entry_point='gym.envs.mujoco:HumanoidSwimBackwardEnv',
    max_episode_steps=1000
)
...
register(
    id='AntForward-v1',
    entry_point='gym.envs.mujoco:AntForwardEnv',
    max_episode_steps=1000,
)
register(
    id='AntBackward-v1',
...
register(
    id='AntCurb-v1',
    entry_point='gym.envs.mujoco:AntCurbEnv',
    max_episode_steps=1000,
)
# Primtives for Humanoid-v1
register(
    id='HumanoidForward-v1',
    entry_point='gym.envs.mujoco:HumanoidForwardEnv',
    max_episode_steps=1000,
)
register(
    id='HumanoidBackward-v1',
    entry_point='gym.envs.mujoco:HumanoidBackwardEnv',
    max_episode_steps=1000,
)
register(
    id='HumanoidCrawl-v1',
    entry_point='gym.envs.mujoco:HumanoidCrawlEnv',
    max_episode_steps=1000,
)
# Meta task for Humanoid-v1
register(
    id='MetaHumanoid1-v1',
    entry_point='gym.envs.mujoco:MetaHumanoid_v1_Env',
    max_episode_steps=3000,
)
# Task for Ant-v1
register(
    id='AntBackForth-v1',
    entry_point='gym.envs.mujoco:AntBackForthEnv',
    max_episode_steps=1000,
)

register(
    id='HumanoidJump-v1',
    entry_point='gym.envs.mujoco:HumanoidJumpEnv',
    max_episode_steps=1000
)

register(
    id='HumanoidHurdle-v1',
    entry_point='gym.envs.mujoco:HumanoidHurdleEnv',
    max_episode_steps=1000
)

register(
    id='HumanoidMovingFloor-v1',
    entry_point='gym.envs.mujoco:HumanoidMovingFloorEnv',
    max_episode_steps=1000
)

register(
    id='Walker2dToy-v1',
    entry_point='gym.envs.mujoco:Walker2dBackNForthEnv',
    max_episode_steps=2000
)
# Atari
# ----------------------------------------
...
for game in [
    ...
    for obs_type in ['image', 'ram']:
        ...
        register(
            ...
            entry_point='gym.envs.atari:AtariEnv',
            kwargs={'game': game, 'obs_type': obs_type,
                    'frameskip': 1, 'repeat_action_probability': 0.25},  # A frameskip of 1 means we get every frame
        ...
        register(
            ...
            entry_point='gym.envs.atari:AtariEnv',
            kwargs={'game': game, 'obs_type': obs_type,
                    'frameskip': 1},  # A frameskip of 1 means we get every frame
            max_episode_steps=frameskip * 100000,
            nondeterministic=nondeterministic,
        )
